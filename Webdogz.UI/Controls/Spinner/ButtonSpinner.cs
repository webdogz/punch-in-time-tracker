...
namespace Webdogz.UI.Controls
{
  ...
  public class SpinnerButton : Spinner
  {
    ...
    public static readonly DependencyProperty AllowSpinProperty = DependencyProperty.Register( "AllowSpin", typeof( bool ), typeof( SpinnerButton ), new UIPropertyMetadata( true, AllowSpinPropertyChanged ) );
    ...
    {
      SpinnerButton source = d as SpinnerButton;
    ...
    /// </summary>
    public static readonly DependencyProperty ContentProperty = DependencyProperty.Register( "Content", typeof( object ), typeof( SpinnerButton ), new PropertyMetadata( null, OnContentPropertyChanged ) );
    ...
    public static readonly DependencyProperty ShowButtonSpinnerProperty = DependencyProperty.Register( "ShowButtonSpinner", typeof( bool ), typeof( SpinnerButton ), new UIPropertyMetadata( true ) );
