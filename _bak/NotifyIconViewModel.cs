...
namespace PunchIn.ViewModels
{
    ...
    public class NotifyIconViewModel : ViewModelBase
    {
        ...
        private PunchMenuItemModel GetWorkItemMenuItems()
        {
            PunchMenuItemModel menu = new PunchMenuItemModel() { Text = "Work Items", Icon = "Resources/list.png" };
            menu.Children.Add(new PunchMenuItemModel
            {
                Text = "New Work Item...",
            ...
            foreach (WorkItem item in this.viewModel.WorkItems.Where(w => w.Status != States.Done))
            {
                ...
                PunchMenuItemModel m = new PunchMenuItemModel
                {
        ...
        public PunchMenuItemModel WorkItemMenus
        {
            get 
            {
        ...
        private PunchMenuItemModel workItemMenus;
        ...
        private ShortcutMenuItemModel GetShortcutMenu(DirectoryInfo root, string name)
        {
            var menu = new ShortcutMenuItemModel() { Text = name ?? root.Name, Icon = "Resources/folder.png" };
            foreach (DirectoryInfo dir in root.GetDirectories())
            {
                ShortcutMenuItemModel item = GetShortcutMenu(dir, dir.Name);
                menu.Children.Add(item);
            }
            foreach (FileInfo file in root.GetFiles("*.*"))
            {
                menu.Children.Add(new ShortcutMenuItemModel()
                {
        ...
        public ShortcutMenuItemModel ShortcutMenus
        {
        ...
        private ShortcutMenuItemModel shortcutMenus;
        #endregion
