...
namespace PunchIn.Themes
{
        ...
        : ViewModelBase
    {
        ...
        /// </summary>
        public static readonly Uri DarkThemeSource = new Uri("/PunchIn;component/Assets/MetroUI.Dark.xaml", UriKind.Relative);
        /// <summary>
        /// The location of the light theme resource dictionary.
        /// </summary>
        public static readonly Uri LightThemeSource = new Uri("/PunchIn;component/Assets/MetroUI.Light.xaml", UriKind.Relative);
        ...
        {
            DarkThemeCommand = new DelegateCommand(o => ThemeSource = DarkThemeSource, o => !DarkThemeSource.Equals(ThemeSource));
            LightThemeCommand = new DelegateCommand(o => ThemeSource = LightThemeSource, o => !LightThemeSource.Equals(ThemeSource));
            SetThemeCommand = new DelegateCommand(o =>
            {
                var uri = GetUri(o);
                if (uri != null) {
                    ThemeSource = uri;
            ...
            AccentColorCommand = new DelegateCommand(o =>
            {
                if (o is Color) {
                    AccentColor = (Color)o;
                }
